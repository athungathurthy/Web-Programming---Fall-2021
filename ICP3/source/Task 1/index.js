...
function win(userOption, computerOption) {
    document.querySelector(".results>p").innerHTML = " Your choice is: " + convertToWord(userOption) + ". Computer choice is: " + convertToWord(computerOption) + ". YOU WIN! Play Again";

}

function lose(userOption, computerOption) {
    document.querySelector(".results>p").innerHTML = " Your choice is: " + convertToWord(userOption) + ". Computer choice is: " + convertToWord(computerOption) + ". YOU LOST | COMPUTER WIN! Play Again";
}

function draw(userOption, computerOption) {
    document.querySelector(".results>p").innerHTML = " Your choice is: " + convertToWord(userOption) + ". Computer choice is: " + convertToWord(computerOption) + ". IT'S A DRAW! Play Again";
}
